...
if __name__ == '__main__':
    ...
    conv_context = "hi can you help me? /n sure"
    background = "in the morning she went to work"
    gc = GraphConstructor()
    # triples, background_entities = query_wikidata(de,question,conv_context,background)
    cg = CandidateGenerator(5)
    ...
    print(background_entities)
    print(conv_context_entities)
    ...
    gpickle.write_gpickle(graph,f"datasets/{args.dataset}/graphtest.json")
